...
$baseUrl = '../';
  ...
  if(isset($_GET['id'])){
    $id = getGet('id');
    $sql = "Select * from category_explore where id = $id";
...
<div class="row" style="margin-top:20px;">
    <div class="col-md-12">
        <h2> Explore category management</h2>
    </div>
    <div class="col-md-6">
        <form method="post" action="index.php" onsubmit="return validateForm();">
            <div class="form-group">
                <label for="usr" style="font-weight: bold;">Tên Danh Mục Triễn Lãm:</label>
